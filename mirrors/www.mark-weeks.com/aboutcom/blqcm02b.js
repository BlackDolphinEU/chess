...
q.NewImage("<IMG SRC=images/blqcm02h.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0023 -->");
q.NewAnswer("Bg7+",false);
q.NewAnswer("Rh4+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.2");
q.NewImage("<IMG SRC=images/blqcm02i.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0026 -->");
q.NewAnswer("Nc7+",false);
q.NewAnswer("Nf6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.3");
q.NewImage("<IMG SRC=images/blqcm02j.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0027 -->");
q.NewAnswer("Rxd8+",false);
q.NewAnswer("Re8+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.4");
q.NewImage("<IMG SRC=images/blqcm02k.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0032 -->");
q.NewAnswer("Bh7+",true);
q.NewAnswer("Bh8",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.5");
q.NewImage("<IMG SRC=images/blqcm02l.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0033 -->");
q.NewAnswer("Nd7+",false);
q.NewAnswer("Ne6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.6");
q.NewImage("<IMG SRC=images/blqcm02m.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0034 -->");
q.NewAnswer("Be8+",false);
q.NewAnswer("e6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.7");
q.NewImage("<IMG SRC=images/blqcm02n.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0036 -->");
q.NewAnswer("Re6",false);
q.NewAnswer("Re7",false);
q.NewAnswer("Both",false);
