...
q.NewImage("<IMG SRC=images/blqcm04a.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0063 -->");
q.NewAnswer("Ng6+",false);
q.NewAnswer("Qxh7+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("4.2");
q.NewImage("<IMG SRC=images/blqcm04b.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0064 -->");
q.NewAnswer("Nxe6+",false);
q.NewAnswer("Qxc6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("4.3");
q.NewImage("<IMG SRC=images/blqcm04c.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0065 -->");
q.NewAnswer("Qb8+",true);
q.NewAnswer("Qxe6+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("4.4");
q.NewImage("<IMG SRC=images/blqcm04d.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0069 -->");
q.NewAnswer("Qc7+",true);
q.NewAnswer("Qd8+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("4.5");
q.NewImage("<IMG SRC=images/blqcm04e.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0072 -->");
q.NewAnswer("Qh8+",true);
q.NewAnswer("fxg7+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("4.6");
q.NewImage("<IMG SRC=images/blqcm04f.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0076 -->");
q.NewAnswer("Qxg7+",false);
q.NewAnswer("Qxh7+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("4.7");
q.NewImage("<IMG SRC=images/blqcm04g.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0077 -->");
q.NewAnswer("Qe8+",false);
