...
function Question_WriteHTML()
{
	document.write('<p>'+this.Image+'</p>');
        document.write('<p>Q' + this.text + ' Which move leads to checkmate in 2 moves?</p>');
...
q = gQuestionList.NewQuestion("6.1");
q.NewImage("<IMG SRC=images/blqcm06a.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0104 -->");
q.NewAnswer("Bxf8+",false);
q.NewAnswer("Qxg6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.2");
q.NewImage("<IMG SRC=images/blqcm06b.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0105 -->");
q.NewAnswer("Qxg8+",false);
q.NewAnswer("Qxh7+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.3");
q.NewImage("<IMG SRC=images/blqcm06c.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0112 -->");
q.NewAnswer("Ne6+",false);
q.NewAnswer("Qf6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.4");
q.NewImage("<IMG SRC=images/blqcm06d.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0113 -->");
q.NewAnswer("Qg7+",false);
q.NewAnswer("Qh7+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.5");
q.NewImage("<IMG SRC=images/blqcm06e.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0114 -->");
q.NewAnswer("Qg6+",true);
q.NewAnswer("Qxh6+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.6");
q.NewImage("<IMG SRC=images/blqcm06f.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0117 -->");
q.NewAnswer("Qf7+",false);
q.NewAnswer("Qg6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.7");
q.NewImage("<IMG SRC=images/blqcm06g.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0118 -->");
q.NewAnswer("Ba6",false);
q.NewAnswer("Nb5",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",true);
