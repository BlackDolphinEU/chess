...
q = gQuestionList.NewQuestion("2.1");
q.NewImage("<IMG SRC=images/blqcm02a.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0023 -->");
q.NewAnswer("Bh8",false);
q.NewAnswer("Qxh6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.2");
q.NewImage("<IMG SRC=images/blqcm02b.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0026 -->");
q.NewAnswer("Qe7+",true);
q.NewAnswer("Qxe6+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.3");
q.NewImage("<IMG SRC=images/blqcm02c.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0027 -->");
q.NewAnswer("Qd8+",true);
q.NewAnswer("Rxe7",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.4");
q.NewImage("<IMG SRC=images/blqcm02d.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0032 -->");
q.NewAnswer("Bxg6",false);
q.NewAnswer("Qxh5",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.5");
q.NewImage("<IMG SRC=images/blqcm02e.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0033 -->");
q.NewAnswer("Qf7+",true);
q.NewAnswer("Qg8+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.6");
q.NewImage("<IMG SRC=images/blqcm02f.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0034 -->");
q.NewAnswer("Qf5+",true);
q.NewAnswer("d6+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("2.7");
q.NewImage("<IMG SRC=images/blqcm02g.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0036 -->");
q.NewAnswer("Qxe8+",true);
q.NewAnswer("Qxf7+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
