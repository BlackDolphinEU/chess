...
q.NewImage("<IMG SRC=images/blqcm01h.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0002 -->");
q.NewAnswer("Bxf6+",true);
q.NewAnswer("Rg8+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.2");
q.NewImage("<IMG SRC=images/blqcm01i.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0003 -->");
q.NewAnswer("Bg6+",true);
q.NewAnswer("Bh4",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.3");
q.NewImage("<IMG SRC=images/blqcm01j.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0006 -->");
q.NewAnswer("Be2+",true);
q.NewAnswer("h3+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.4");
q.NewImage("<IMG SRC=images/blqcm01k.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0008 -->");
q.NewAnswer("g5",false);
q.NewAnswer("g3+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.5");
q.NewImage("<IMG SRC=images/blqcm01l.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0016 -->");
q.NewAnswer("Rf8+",true);
q.NewAnswer("gxh7+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.6");
q.NewImage("<IMG SRC=images/blqcm01m.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0017 -->");
q.NewAnswer("Bf7+",true);
q.NewAnswer("Rf6+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.7");
q.NewImage("<IMG SRC=images/blqcm01n.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0019 -->");
