...
q = gQuestionList.NewQuestion("1.1");
q.NewImage("<IMG SRC=images/blqcm01a.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0002 -->");
q.NewAnswer("Qxf6+",true);
q.NewAnswer("Rg8+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.2");
q.NewImage("<IMG SRC=images/blqcm01b.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0003 -->");
q.NewAnswer("Bg6+",false);
q.NewAnswer("Qh5+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.3");
q.NewImage("<IMG SRC=images/blqcm01c.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0006 -->");
q.NewAnswer("Bg6+",false);
q.NewAnswer("Qxg4+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.4");
q.NewImage("<IMG SRC=images/blqcm01d.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0008 -->");
q.NewAnswer("Qd8+",false);
q.NewAnswer("Qe1+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.5");
q.NewImage("<IMG SRC=images/blqcm01e.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0016 -->");
q.NewAnswer("Qe8+",true);
q.NewAnswer("gxh7+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.6");
q.NewImage("<IMG SRC=images/blqcm01f.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0017 -->");
q.NewAnswer("Bf7+",false);
q.NewAnswer("Qg4+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("1.7");
q.NewImage("<IMG SRC=images/blqcm01g.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0019 -->");
q.NewAnswer("Qh6",false);
q.NewAnswer("Rxg7",false);
q.NewAnswer("Both",false);
