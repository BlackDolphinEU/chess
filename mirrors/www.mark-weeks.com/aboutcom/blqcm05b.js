...
q.NewImage("<IMG SRC=images/blqcm05h.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0079 -->");
q.NewAnswer("Bxh8",false);
q.NewAnswer("Rxh8+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.2");
q.NewImage("<IMG SRC=images/blqcm05i.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0088 -->");
q.NewAnswer("Bg8",false);
q.NewAnswer("Bxh6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.3");
q.NewImage("<IMG SRC=images/blqcm05j.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0094 -->");
q.NewAnswer("Ba6+",true);
q.NewAnswer("Be6+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.4");
q.NewImage("<IMG SRC=images/blqcm05k.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0098 -->");
q.NewAnswer("Bb5+",false);
q.NewAnswer("Ra3+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.5");
q.NewImage("<IMG SRC=images/blqcm05l.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0099 -->");
q.NewAnswer("Nf5+",true);
q.NewAnswer("Rg6+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.6");
q.NewImage("<IMG SRC=images/blqcm05m.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0100 -->");
q.NewAnswer("Bf6+",true);
q.NewAnswer("Ng6+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.7");
q.NewImage("<IMG SRC=images/blqcm05n.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0102 -->");
q.NewAnswer("Bxh7+",true);
