...
q.NewImage("<IMG SRC=images/blqcm03h.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0040 -->");
q.NewAnswer("Nf7+",true);
q.NewAnswer("Nxh7",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.2");
q.NewImage("<IMG SRC=images/blqcm03i.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0049 -->");
q.NewAnswer("Re6+",true);
q.NewAnswer("Rxe5+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.3");
q.NewImage("<IMG SRC=images/blqcm03j.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0050 -->");
q.NewAnswer("Bg6+",false);
q.NewAnswer("Ra5",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",true);
q = gQuestionList.NewQuestion("3.4");
q.NewImage("<IMG SRC=images/blqcm03k.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0053 -->");
q.NewAnswer("Rd7",false);
q.NewAnswer("Rd8+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.5");
q.NewImage("<IMG SRC=images/blqcm03l.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0054 -->");
q.NewAnswer("Rf7",false);
q.NewAnswer("Rf8+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.6");
q.NewImage("<IMG SRC=images/blqcm03m.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0055 -->");
q.NewAnswer("Rd4+",true);
q.NewAnswer("Rxe7+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.7");
q.NewImage("<IMG SRC=images/blqcm03n.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0058 -->");
q.NewAnswer("Rb8+",true);
