...
q = gQuestionList.NewQuestion("5.1");
q.NewImage("<IMG SRC=images/blqcm05a.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0079 -->");
q.NewAnswer("Qh7+",false);
q.NewAnswer("Qh8+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.2");
q.NewImage("<IMG SRC=images/blqcm05b.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0088 -->");
q.NewAnswer("Bh6+",false);
q.NewAnswer("Qh6+",false);
q.NewAnswer("Both",true);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.3");
q.NewImage("<IMG SRC=images/blqcm05c.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0094 -->");
q.NewAnswer("Be6+",false);
q.NewAnswer("Qxc6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.4");
q.NewImage("<IMG SRC=images/blqcm05d.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0098 -->");
q.NewAnswer("Qxa6+",true);
q.NewAnswer("Ra3",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.5");
q.NewImage("<IMG SRC=images/blqcm05e.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0099 -->");
q.NewAnswer("Nf5+",false);
q.NewAnswer("Qh5+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.6");
q.NewImage("<IMG SRC=images/blqcm05f.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0100 -->");
q.NewAnswer("Ng6+",false);
q.NewAnswer("Qxh6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("5.7");
q.NewImage("<IMG SRC=images/blqcm05g.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0102 -->");
q.NewAnswer("Bh7+",false);
