...
q.NewImage("<IMG SRC=images/blqcm06h.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0104 -->");
q.NewAnswer("Bxf8+",true);
q.NewAnswer("fxg6+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.2");
q.NewImage("<IMG SRC=images/blqcm06i.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0105 -->");
q.NewAnswer("Rf7+",false);
q.NewAnswer("Rh4+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.3");
q.NewImage("<IMG SRC=images/blqcm06j.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0112 -->");
q.NewAnswer("Bc7+",false);
q.NewAnswer("Be7+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.4");
q.NewImage("<IMG SRC=images/blqcm06k.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0113 -->");
q.NewAnswer("Nf7+",false);
q.NewAnswer("Rxh7+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.5");
q.NewImage("<IMG SRC=images/blqcm06l.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0114 -->");
q.NewAnswer("Bxg6+",false);
q.NewAnswer("fxg6+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.6");
q.NewImage("<IMG SRC=images/blqcm06m.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0117 -->");
q.NewAnswer("Nd6+",false);
q.NewAnswer("Ng7+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("6.7");
q.NewImage("<IMG SRC=images/blqcm06n.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0118 -->");
q.NewAnswer("Ba6+",true);
