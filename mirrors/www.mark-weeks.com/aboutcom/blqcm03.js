...
q = gQuestionList.NewQuestion("3.1");
q.NewImage("<IMG SRC=images/blqcm03a.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0040 -->");
q.NewAnswer("Nf7+",false);
q.NewAnswer("Qg8+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.2");
q.NewImage("<IMG SRC=images/blqcm03b.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0049 -->");
q.NewAnswer("Qxe5+",true);
q.NewAnswer("Rxe5+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.3");
q.NewImage("<IMG SRC=images/blqcm03c.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0050 -->");
q.NewAnswer("Bxg6",false);
q.NewAnswer("Qxh7+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.4");
q.NewImage("<IMG SRC=images/blqcm03d.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0053 -->");
q.NewAnswer("Qxe8+",true);
q.NewAnswer("Rd8",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.5");
q.NewImage("<IMG SRC=images/blqcm03e.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0054 -->");
q.NewAnswer("Qd8+",true);
q.NewAnswer("Rf8+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.6");
q.NewImage("<IMG SRC=images/blqcm03f.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0055 -->");
q.NewAnswer("Qe1+",false);
q.NewAnswer("Qe7+",true);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
q = gQuestionList.NewQuestion("3.7");
q.NewImage("<IMG SRC=images/blqcm03g.gif WIDTH=280 HEIGHT=280><!-- REI-1KCM:0058 -->");
q.NewAnswer("Qxf8+",true);
q.NewAnswer("Rg7+",false);
q.NewAnswer("Both",false);
q.NewAnswer("Neither",false);
